...
class NetworkLayout : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val autoScrollRunnable = object : Runnable {
            override fun run() {
                ...
                handler.postDelayed(this, 2500) // Auto-scroll every 3 seconds
            }
        }
    ...
    override fun onBackPressed() {
        // Get the currently displayed fragment in the container
        val currentFragment = supportFragmentManager.findFragmentById(R.id.fragmentContainer)

        // Check if the fragment is one of the specified types
        if (currentFragment is Internships ||
            ...
            // Show the main content and hide the fragment container
            ...
            // If fragments are in the back stack, pop the last fragment
            ...
            // No more fragments in back stack, finish the activity
            super.onBackPressed()
        }
    }
